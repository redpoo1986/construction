jQuery( function ( $ ) {
	$( '#xo-slider-slide' ).each( function ( i, e ) {
		...
		// Add slide.
		wrapper.find( '.slide-header-append-button' ).on( 'click', function () {
			count++;
		...
		// Delete slide.
		wrapper.find( '.slide-header-remove-button' ).on( 'click', function () {
		...
		wrapper.find( '.slide-header-toggle-button' ).on( 'click', function () {
			var slide = $( this ).parents( '.slide' );
		...
		// Set image.
		wrapper.find( '.slide-image' ).on( 'click', function ( e ) {
			e.preventDefault();
		...
		// Delete image.
		wrapper.find( '.slide-image-clear' ).on( 'click', function ( e ) {
			e.preventDefault();
		...
		// Slide panel tab.
		wrapper.find( '.slide-panel-tabs' ).on( 'click', function ( e ) {
			var target = $( e.target );
	...
	// Parameter panel tab.
	$( '#xo-slider-parameter .parameter-panel-tabs' ).on( 'click', function ( e ) {
		var target = $( e.target );
		if ( target.hasClass( 'nav-tab-link' ) ) {
			panelId = target.data( 'type' );
